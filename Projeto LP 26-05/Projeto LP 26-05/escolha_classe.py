...
def escolher_classe(nome_char):
    ...
    while escolha_classe:
        ...
        match classe:
            ...
            case 4:
                print(f'O Druida é ligado à natureza, aos espíritos e aos animais. \n Principal característica: Conexão animal e com a natureza')
                print('Selecionar classe a de Druida? \n 1 - Sim \n 2 - Não')
                escolha = int(input())
