...
nome_dog = adoção(nome_dog)

cap_02.iniciar(nome_char, classe, status_list, nome_dog)

cap_03.iniciar(nome_char, classe, status_list, nome_dog)

cap_03D.iniciar(nome_char, classe, status_list)
